...
(assert-not (par (a) (forall ((t (treeh a)) (x a) (y a)) (=> (and (consistent a t) (in_alphabet a x t) (in_alphabet a y t) (leq nat (freq a t x) (freq a t y)) (leq nat (depth a t x) (depth a t y))) (leq nat (cost a (swapSyms a t x y)) (cost a t))))))
