...
(assert-not (par (a) (forall ((t (tree a)) (bs (list Bool))) (=> (and (braun a t) (leq nat (s zero) (nat_of bs)) (leq nat (nat_of bs) (size a t))) (= (lookup_trie a t bs) (lookup1 a t (nat_of bs)))))))
