...
(assert-not (par (a) (forall ((x a) (n nat) (t (tree a)) (t' (tree a))) (=> (= (braun2_of a x n) (Pair (tree a) (tree a) t t')) (and (= (list_of a t) (replicate a n x)) (= (list_of a t') (replicate a (s n) x)))))))
