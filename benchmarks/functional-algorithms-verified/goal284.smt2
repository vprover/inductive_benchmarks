...
(assert-not (par (a) (forall ((t (treeh a)) (x a)) (=> (and (consistent a t) (distinct (sibling a t x) x)) (= (plus (plus (cost a (mergeSibling a t x)) (freq a t x)) (freq a t (sibling a t x))) (cost a t))))))
