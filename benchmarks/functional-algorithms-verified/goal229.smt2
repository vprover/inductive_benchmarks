...
(assert-not (par (a) (forall ((n nat) (xs (list a)) (ys (list a))) (=> (and (less nat n (plus (len a xs) (len a ys))) (leq nat (len a ys) (len a xs)) (leq nat (len a xs) (s (len a ys)))) (= (nth a (splice a xs ys) n) (nth a (ite (even n) xs ys) (div2 n)))))))
