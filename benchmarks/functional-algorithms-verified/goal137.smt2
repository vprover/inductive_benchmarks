...
(assert-not (par (a) (forall ((x (ivl a)) (s (itree a))) (=> (and (inv_max_hi a s) (sorted_s (ivl a) (inorderp (ivl a) a s))) (and (inv_max_hi a (insert_ivl a x s)) (sorted_s (ivl a) (inorderp (ivl a) a (insert_ivl a x s))))))))
