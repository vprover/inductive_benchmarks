...
(assert-not (par (a) (forall ((x (ivl a)) (s (itree a))) (=> (and (inv_max_hi a s) (sorted_s (ivl a) (inorderp (ivl a) a s))) (forall ((y (ivl a))) (= (in_set_ptree (ivl a) a y (delete_ivl a x s)) (and (in_set_ptree (ivl a) a y s) (distinct x y))))))))
