...
(assert-not (par (a) (forall ((x a) (l (tree_ht a)) (r (tree_ht a))) (=> (and (avl a l) (avl a r) (leq nat (h (pair a nat) r) (s (h (pair a nat) l))) (leq nat (h (pair a nat) l) (s (s (h (pair a nat) r))))) (avl a (balL a l x r))))))
