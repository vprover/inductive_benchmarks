...
(assert-not (par (a) (forall ((l (tree a)) (x a) (r (tree a)) (n nat)) (=> (and (braun a (Node a l x r)) (in_range n (s zero) (size a (Node a l x r))) (less nat (s zero) n)) (and (=> (odd n) (in_range (div2 n) (s zero) (size a r))) (=> (even n) (in_range (div2 n) (s zero) (size a l))))))))
