...
(assert-not (par (a) (forall ((ts (list (treeh a))) (x a) (y a) (wx nat) (wy nat)) (=> (and (consistent_F a ts) (distinct ts (Nil (treeh a))) (in_alphabet_F a x ts) (= (freq_F a ts x) (plus wx wy))) (= (splitLeaf a (huffman a ts) wx x wy y) (huffman a (splitLeaf_F a ts wx x wy y)))))))
