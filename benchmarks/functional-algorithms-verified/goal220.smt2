...
;(assert (par (a) (forall ((xs (list a))) (= (rbt_of_list a xs) (join_all23 a (leaves23 a xs))))))
...
(assert-not (par (a) (forall ((l (rbt a)) (x a) (r (rbt a))) (=> (and (invc a l) (invc a r) (invh a l) (invh a r) (leq nat (bh a l) (bh a r)))
  (and (invc2 a (joinL a l x r)) (=> (and (distinct (bh a l) (bh a r)) (= (color_of a r) Black)) (invc a (joinL a l x r))) (invh a (joinL a l x r)) (= (bh a (joinL a l x r)) (bh a l)))))))
