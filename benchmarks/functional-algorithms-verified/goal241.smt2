...
(assert-not (par (a) (forall ((y a) (xs (list a)) (ys (list a))) (=> (leq nat (len a xs) (s (len a ys))) (= (splice a xs (append a ys (Cons a y (Nil a)))) (append a (splice a xs ys) (Cons a y (Nil a))))))))
