...
(assert-not (par (a) (forall ((l (rbt a)) (r (rbt a)) (t' (rbt a))) (=> (and (invh a l) (invh a r) (= (bh a l) (bh a r)) (invc a l) (invc a r) (= t' (joinRB a l r))) (and (invh a t') (= (bh a t') (bh a l)) (invc2 a t') (=> (= (color_of a l) Black) (invc a t')))))))
