...
; (assert (par (a) (forall ((t1 (rbt a)) (x a) (t2 (rbt a)) (t3 (rbt a)) (c a) (t4 (rbt a))) (= (joinRB a (R a t1 x t2) (R a t3 c t4))
;  (match (joinRB a t2 t3) (((R a u2 b u3) (R a (R a t1 x u2) b (R a u3 c t4)))
;                         (t23 (R a t1 x (R a t23 c t4)))))))))
; (assert (par (a) (forall ((t1 (rbt a)) (x a) (t2 (rbt a)) (t3 (rbt a)) (c a) (t4 (rbt a))) (= (joinRB a (B a t1 x t2) (B a t3 c t4))
;  (match (joinRB a t2 t3) (((R a u2 b u3) (R a (B a t1 x u2) b (B a u3 c t4)))
;                         (t23 (baldL a t1 x (R a t23 c t4)))))))))
...
; invh(l) & invh(r) & bh(l) = bh(r) & invc(l) & invc(r) & t' = join(l,r) -> invh(t') & bh(t') = bh(l) & invc2(t') & (color(l) = Black & color(r) = Black -> invc(t'))
(assert-not (par (a) (forall ((l (rbt a)) (r (rbt a)) (t' (rbt a))) (=> (and (invh a l) (invh a r) (= (bh a l) (bh a r)) (invc a l) (invc a r) (= t' (joinRB a l r)))
