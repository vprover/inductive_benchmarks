...
(assert-not (par (a) (forall ((t (treeh a)) (x a) (y a) (wx nat) (wy nat)) (=> (and (consistent a t) (optimum a t) (in_alphabet a x t) (not (in_alphabet a y t)) (= (freq a t x) (plus wx wy)) (forall ((z a)) (=> (in_alphabet a z t) (and (leq nat wx (freq a t z)) (leq nat wy (freq a t z)))))) (optimum a (splitLeaf a t wx x wy y))))))
