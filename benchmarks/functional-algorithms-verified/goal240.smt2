...
(assert-not (par (a) (forall ((x a) (xs (list a)) (ys (list a))) (=> (leq nat (len a ys) (len a xs)) (= (splice a (append a xs (Cons a x (Nil a))) ys) (splice a xs (append a ys (Cons a x (Nil a)))))))))
