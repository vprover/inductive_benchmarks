...
(assert-not (par (a b) (forall ((t (ptree a b)) (m a) (t' (ptree a b))) (=> (and (= (split_minp a b t) (Pair a (ptree a b) m t')) (distinct t (LeafP a b))) (and (in_set_ptree a b m t) (forall ((x a)) (= (in_set_ptree a b x t) (or (= x m) (in_set_ptree a b x t')))))))))
