...
(assert-not (par (a b) (forall ((t (ptree a b)) (x a) (y Bool) (l (ptree a b)) (r (ptree a b))) (=> (and (= (splitp a b t x) (Triple (ptree a b) Bool (ptree a b) l y r)) (bst (pair a b) t)) (and (forall ((z a)) (= (in_set_ptree a b z l) (and (in_set_ptree a b z t) (less a z x)))) (forall ((z a)) (= (in_set_ptree a b z r) (and (in_set_ptree a b z t) (less a x z)))) (= y (in_set_ptree a b x t)) (bst (pair a b) l) (bst (pair a b) r))))))
