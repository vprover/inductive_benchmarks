...
(assert-not (par (a) (forall ((i nat) (ls (list (tree a))) (xs (list a)) (rs (list (tree a)))) (=> (less nat i (len a xs)) (= (nth (tree a) (nodes a ls xs rs) i) (Node a (ite (less nat i (len (tree a) ls)) (nth (tree a) ls i) (Leaf a)) (nth a xs i) (ite (less nat i (len (tree a) rs)) (nth (tree a) rs i) (Leaf a))))))))
