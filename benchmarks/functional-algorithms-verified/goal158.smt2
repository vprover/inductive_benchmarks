...
(assert-not (par (a) (forall ((n nat) (ts (tree23s a))) (=> (forall ((t (tree23 a))) (=> (in_trees a t ts) (and (complete23 a t) (= (h23 a t) n)))) (forall ((t (tree23 a))) (=> (in_trees a t (join_adj a ts)) (and (complete23 a t) (= (h23 a t) (s n)))))))))
