...
(assert-not (par (a b) (forall ((t (ptree a b)) (m a) (t' (ptree a b))) (=> (and (= (split_minp a b t) (Pair a (ptree a b) m t')) (bst (pair a b) t) (distinct t (LeafP a b))) (and (bst (pair a b) t') (forall ((x a)) (=> (in_set_ptree a b x t') (less a m x))))))))
