...
;(assert-not (par (a) (forall ((k nat) (ts (list a)) (xs (list a))) (=> (and (= (len a ts) (pow (s (s zero)) k)) (forall ((i nat)) (=> (less nat i (pow (s (s zero)) k)) (braun_list a (nths a ts i) (take_nths a i k xs))))) (= (list_fast_rec a ts) xs)))))
