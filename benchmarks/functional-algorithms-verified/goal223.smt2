...
(assert-not (par (a b) (forall ((t1 (ptree a b)) (t2 (ptree a b))) (=> (and (bst (pair a b) t1) (bst (pair a b) t2)) (forall ((x a)) (= (in_set_ptree a b x (diff1 a b t1 t2)) (and (in_set_ptree a b x t1) (not (in_set_ptree a b x t2)))))))))
