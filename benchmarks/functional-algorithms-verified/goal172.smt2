...
(assert-not (par (a) (forall ((t (rbt a)) (x a) (t' (rbt a))) (=> (and (= (split_minRB a t) (Pair a (rbt a) x t')) (distinct t (LeafP a color)) (invh a t) (invc a t)) (and (invc a t') (=> (= (color_of a t) Red) (and (= (bh a t') (bh a t)) (invc a t'))) (=> (= (color_of a t) Black) (and (= (s (bh a t')) (bh a t)) (invc2 a t'))))))))
