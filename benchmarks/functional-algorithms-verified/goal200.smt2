...
(assert-not (par (a) (forall ((x a) (t (tree_bal a)) (t' (tree_bal a))) (=> (and (= (split_max_bal a t) (Pair (tree_bal a) a t' x)) (avl_bal a t) (distinct t (LeafP a bal))) (and (avl_bal a t') (= (h (pair a bal) t) (ite (decr a a t t') (s (h (pair a bal) t')) (h (pair a bal) t'))))))))
