...
(assert-not (par (a) (forall ((xs (list a)) (ys (list a))) (=> (or (= (len a xs) (len a ys)) (= (len a xs) (s (len a ys)))) (and (= (take_nths a zero (s zero) (splice a xs ys)) xs) (= (take_nths a (s zero) (s zero) (splice a xs ys)) ys))))))
