...
(assert-not (par (a) (forall ((xs (list a))) (or (= (len a (take_nths a zero (s zero) xs)) (len a (take_nths a (s zero) (s zero) xs))) (= (len a (take_nths a zero (s zero) xs)) (s (len a (take_nths a (s zero) (s zero) xs))))))))
