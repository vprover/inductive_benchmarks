...
(assert-not (par (a) (forall ((l (rbt a)) (x a) (r (rbt a))) (=> (less nat (bh a l) (bh a r)) (forall ((y a)) (= (in_set_ptree a color y (joinL a l x r)) (or (in_set_ptree a color y l) (= x y) (in_set_ptree a color y r))))))))
