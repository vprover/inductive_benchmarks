...
(assert-not (par (a) (forall ((l (rbt a)) (x a) (r (rbt a)) (t' (rbt a))) (=> (and (invh a l) (invh a r) (= (s (bh a l)) (bh a r)) (invc2 a l) (invc a r) (= t' (baldL a l x r))) (and (invh a t') (= (bh a t') (bh a r)) (invc2 a t') (=> (= (color_of a r) Black) (invc a t')))))))
