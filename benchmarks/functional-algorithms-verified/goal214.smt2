...
(assert-not (par (a b) (forall ((t1 (ptree a b)) (t2 (ptree a b))) (=> (and (bst (pair a b) t1) (bst (pair a b) t2)) (forall ((x a)) (= (in_set_ptree a b x (inter a b t1 t2)) (and (in_set_ptree a b x t1) (in_set_ptree a b x t2))))))))
