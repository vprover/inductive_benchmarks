...
(assert (par (a) (forall ((x a) (l (rbt a)) (y a) (c color) (r (rbt a))) (= (delRB a x (Node (pair a color) l (Pair a color y c) r))
  (match (cmp a x y) ((LT (let ((ll (delRB a x l))) (ite (and (distinct l (Leaf (pair a color))) (= (color_of a l) Black)) (baldL a (ll a) y r) (R a (ll a) y r))))
                      ...
                      (GT (let ((rr (delRB a x r))) (ite (and (distinct r (Leaf (pair a color))) (= (color_of a r) Black)) (baldR a l y (rr a)) (R a l y (rr a)))))))))))
...
(assert (par (a) (forall ((l (tree_ht a)) (x a) (n nat) (r (tree_ht a))) (= (split_max a (Node (pair a nat) l (Pair a nat x n) r))
  (ite (= r (Leaf (pair a nat))) (Pair (tree_ht a) a l x) (let ((rx (split_max a r))) (Pair (tree_ht a) a (balL a l x (Pair_0 (tree_ht a) a (rx a))) (Pair_1 (tree_ht a) a (rx a)))))))))
...
(assert (par (a) (forall ((x a) (l (tree_ht a)) (y a) (n nat) (r (tree_ht a))) (= (deleteAVL a x (Node (pair a nat) l (Pair a nat y n) r))
  (match (cmp a x y) ((LT (balR a (deleteAVL a x l) y r))
                      (EQ (ite (= l (Leaf (pair a nat))) r (let ((ly (split_max a l))) (balR a (Pair_0 (tree_ht a) a (ly a)) (Pair_1 (tree_ht a) a (ly a)) r))))
...
(assert (par (a) (forall ((A (tree_bal a)) (x a) (B1 (tree_bal a)) (y a) (b bal) (B2 (tree_bal a)) (z a) (C (tree_bal a)))
  (= (rot2 a A x (Node (pair a bal) B1 (Pair a bal y b) B2) z C) (let ((b1 (ite (= b Rh) Lh Bal)) (b2 (ite (= b Lh) Rh Bal)))
...
(assert (par (a) (forall ((x a) (l (tree_bal a)) (y a) (b bal) (r (tree_bal a))) (= (insert_bal a x (Node (pair a bal) l (Pair a bal y b) r))
  (match (cmp a x y) ((LT (let ((l' (insert_bal a x l))) (ite (incr a a l (l' a)) (balL_bal a (l' a) y b r) (Node (pair a bal) (l' a) (Pair a bal y b) r))))
                      (EQ (Node (pair a bal) l (Pair a bal y b) r))
                      (GT (let ((r' (insert_bal a x r))) (ite (incr a a r (r' a)) (balR_bal a l y b (r' a)) (Node (pair a bal) l (Pair a bal y b) (r' a)))))))))))
...
(assert (par (a) (forall ((l (tree_bal a)) (x a) (b bal) (r (tree_bal a))) (= (split_max_bal a (Node (pair a bal) l (Pair a bal x b) r))
  (ite (= r (Leaf (pair a bal))) (Pair (tree_bal a) a l x) (let ((rx (split_max_bal a r)))
    (let ((t (ite (decr a a r (Pair_0 (tree_bal a) a (rx a))) (balL_bal a l x b (Pair_0 (tree_bal a) a (rx a)))
      (Node (pair a bal) l (Pair a bal x b) (Pair_0 (tree_bal a) a (rx a)))))) (Pair (tree_bal a) a (t a) (Pair_1 (tree_bal a) a (rx a))))))))))
...
(assert (par (a) (forall ((x a) (l (tree_bal a)) (y a) (b bal) (r (tree_bal a))) (= (delete_bal a x (Node (pair a bal) l (Pair a bal y b) r))
  (match (cmp a x y) ((LT (let ((l' (delete_bal a x l))) (ite (decr a a l (l' a)) (balR_bal a (l' a) y b r) (Node (pair a bal) (l' a) (Pair a bal y b) r))))
                      (EQ (ite (= l (Leaf (pair a bal))) r (let ((ly (split_max_bal a l))) (ite (decr a a l (Pair_0 (tree_bal a) a (ly a)))
                        (balR_bal a (Pair_0 (tree_bal a) a (ly a)) (Pair_1 (tree_bal a) a (ly a)) b r)
                        (Node (pair a bal) (Pair_0 (tree_bal a) a (ly a)) (Pair a bal (Pair_1 (tree_bal a) a (ly a)) b) r)))))
                      (GT (let ((r' (delete_bal a x r))) (ite (decr a a r (r' a)) (balL_bal a l y b (r' a)) (Node (pair a bal) l (Pair a bal y b) (r' a)))))))))))
