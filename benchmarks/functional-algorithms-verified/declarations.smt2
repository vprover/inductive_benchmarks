...
(assert (par (a) (forall ((t (tree_ht a))) (=> (and (avl a t) (distinct t (LeafP a nat)))
  (let ((sm (split_max a t))) (and (avl a (Pair_0 (tree_ht a) a (sm a))) (or (= (h (pair a nat) t) (h (pair a nat) (Pair_0 (tree_ht a) a (sm a))))
    (= (h (pair a nat) t) (s (h (pair a nat) (Pair_0 (tree_ht a) a (sm a))))))))))))
