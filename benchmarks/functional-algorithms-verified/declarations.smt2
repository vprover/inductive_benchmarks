...
(declare-fun count (par (a) (a (list a)) Int))
(assert (par (a) (forall ((x a)) (= (count a x (Nil a)) 1))))
(assert (par (a) (forall ((x a) (y a) (ys (list a))) (= (count a x (Cons a y ys)) (ite (= x y) (+ 1 (count a x ys)) (count a x ys))))))
...
(declare-fun T_append (par (a) ((list a) (list a)) Int))
(assert (par (a) (forall ((ys (list a))) (= (T_append a (Nil a) ys) 1))))
(assert (par (a) (forall ((x a) (xs (list a)) (ys (list a))) (= (T_append a (Cons a x xs) ys) (+ (T_append a xs ys) 1)))))
(declare-fun T_rev (par (a) ((list a)) Int))
(assert (par (a) (= (T_rev a (Nil a)) 1)))
(assert (par (a) (forall ((x a) (xs (list a))) (= (T_rev a (Cons a x xs)) (+ (T_rev a xs) (T_append a (rev a xs) (Cons a x (Nil a))) 1)))))
(declare-fun T_itrev (par (a) ((list a) (list a)) Int))
(assert (par (a) (forall ((ys (list a))) (= (T_itrev a (Nil a) ys) 1))))
(assert (par (a) (forall ((x a) (xs (list a)) (ys (list a))) (= (T_itrev a (Cons a x xs) ys) (+ (T_itrev a xs (Cons a x ys)) 1)))))
...
(declare-fun T_insort (par (a) (a (list a)) Int))
(assert (par (a) (forall ((x a)) (= (T_insort a x (Nil a)) 1))))
(assert (par (a) (forall ((x a) (y a) (ys (list a))) (= (T_insort a x (Cons a y ys)) (+ (ite (leq a x y) 0 (T_insort a x ys)) 1)))))
(declare-fun T_isort (par (a) ((list a)) Int))
(assert (par (a) (= (T_isort a (Nil a)) 1)))
(assert (par (a) (forall ((x a) (xs (list a))) (= (T_isort a (Cons a x xs)) (+ (T_isort a xs) (T_insort a x (isort a xs)) 1)))))
...
(declare-fun len (par (a) ((list a)) Int))
(assert (par (a) (= (len a (Nil a)) 0)))
(assert (par (a) (forall ((x a) (xs (list a))) (= (len a (Cons a x xs)) (+ (len a xs) 1)))))
(declare-fun T_quicksort (par (a) ((list a)) Int))
(assert (par (a) (= (T_quicksort a (Nil a)) 1)))
(assert (par (a) (forall ((x a) (xs (list a))) (= (T_quicksort a (Cons a x xs))
  (+ (T_quicksort a (filter_less a x xs)) (T_quicksort a (filter_ge a x xs)) (* 2 (len a xs)) 1)))))
...
(declare-fun take (par (a) (Int (list a)) (list a)))
(assert (par (a) (forall ((n Int)) (= (take a n (Nil a)) (Nil a)))))
(assert (par (a) (forall ((n Int) (x a) (xs (list a))) (= (take a n (Cons a x xs)) (ite (> n 0) (Cons a x (take a (- n 1) xs)) (Nil a))))))
(declare-fun drop (par (a) (Int (list a)) (list a)))
(assert (par (a) (forall ((n Int)) (= (drop a n (Nil a)) (Nil a)))))
(assert (par (a) (forall ((n Int) (x a) (xs (list a))) (= (drop a n (Cons a x xs)) (ite (> n 0) (drop a (- n 1) xs) xs)))))
(declare-fun msort (par (a) ((list a)) (list a)))
(assert (par (a) (forall ((xs (list a))) (= (msort a xs) (let ((n (len a xs))) (ite (<= n 1) xs
  (merge a (msort a (take a (div n 2) xs)) (msort a (drop a (div n 2) xs)))))))))
(declare-fun C_merge (par (a) ((list a) (list a)) Int))
(assert (par (a) (forall ((ys (list a))) (= (C_merge a (Nil a) ys) 0))))
(assert (par (a) (forall ((xs (list a))) (= (C_merge a xs (Nil a)) 0))))
(assert (par (a) (forall ((x a) (xs (list a)) (y a) (ys (list a))) (= (C_merge a (Cons a x xs) (Cons a y ys))
  (+ 1 (ite (leq a x y) (C_merge a xs (Cons a y ys)) (C_merge a (Cons a x xs) ys)))))))
(declare-fun C_msort (par (a) ((list a)) Int))
...
;  (ite (<= n 1) 0 (+ (C_msort a ys) (C_msort a zs) (C_merge a (msort a ys) (msort a zs))))))))))
...
(declare-fun C_merge_adj (par (a) ((lists a)) Int))
(assert (par (a) (= (C_merge_adj a (Nil (list a))) 0)))
(assert (par (a) (forall ((xs (list a))) (= (C_merge_adj a (Cons (list a) xs (Nil (list a)))) 0))))
(assert (par (a) (forall ((xs (list a)) (ys (list a)) (zss (lists a))) (= (C_merge_adj a (Cons (list a) xs (Cons (list a) ys zss)))
  (+ (C_merge a xs ys) (C_merge_adj a zss))))))
(declare-fun C_merge_all (par (a) ((lists a)) Int))
(assert (par (a) (= (C_merge_all a (Nil (list a))) 0)))
(assert (par (a) (forall ((xs (list a))) (= (C_merge_all a (Cons (list a) xs (Nil (list a)))) 0))))
(assert (par (a) (forall ((xss (lists a))) (= (C_merge_all a xss) (+ (C_merge_adj a xss) (C_merge_all a (merge_adj a xss)))))))
(declare-fun C_msort_bu (par (a) ((list a)) Int))
...
(declare-fun C_runs (par (a) ((list a)) Int))
(declare-fun C_asc (par (a) (a (list a)) Int))
(assert (par (a) (forall ((x a)) (= (C_asc a x (Nil a)) 0))))
(assert (par (a) (forall ((x a) (y a) (ys (list a))) (= (C_asc a x (Cons a y ys))
  (+ 1 (ite (not (less a y x)) (C_asc a y ys) (C_runs a (Cons a y ys))))))))
(declare-fun C_desc (par (a) (a (list a)) Int))
(assert (par (a) (forall ((x a)) (= (C_desc a x (Nil a)) 0))))
(assert (par (a) (forall ((x a) (y a) (ys (list a))) (= (C_desc a x (Cons a y ys))
  (+ 1 (ite (less a y x) (C_desc a y ys) (C_runs a (Cons a y ys))))))))
(assert (par (a) (= (C_runs a (Nil a)) 0)))
(assert (par (a) (forall ((x a)) (= (C_runs a (Cons a x (Nil a))) 0))))
(assert (par (a) (forall ((x a) (y a) (xs (list a))) (= (C_runs a (Cons a x (Cons a y xs)))
  (+ 1 (ite (less a y x) (C_desc a y xs) (C_asc a y xs)))))))
(declare-fun C_nmsort (par (a) ((list a)) Int))
(assert (par (a) (forall ((xs (list a))) (= (C_nmsort a xs) (+ (C_runs a xs) (C_merge_all a (runs a xs)))))))
...
(declare-fun size (par (a) ((tree a)) Int))
(assert (par (a) (= (size a (Leaf a)) 0)))
(assert (par (a) (forall ((l (tree a)) (x a) (r (tree a))) (= (size a (Node a l x r)) (+ (size a l) (size a r) 1)))))
(declare-fun size1 (par (a) ((tree a)) Int))
(assert (par (a) (= (size1 a (Leaf a)) 1)))
(assert (par (a) (forall ((l (tree a)) (x a) (r (tree a))) (= (size1 a (Node a l x r)) (+ (size1 a l) (size1 a r))))))
(declare-fun h (par (a) ((tree a)) Int))
(assert (par (a) (= (h a (Leaf a)) 0)))
(assert (par (a) (forall ((l (tree a)) (x a) (r (tree a))) (= (h a (Node a l x r)) (+ (max (h a l) (h a r)) 1)))))
(declare-fun mh (par (a) ((tree a)) Int))
(assert (par (a) (= (mh a (Leaf a)) 0)))
(assert (par (a) (forall ((l (tree a)) (x a) (r (tree a))) (= (mh a (Node a l x r)) (+ (min (mh a l) (mh a r)) 1)))))
...
(assert (par (a) (forall ((t (tree a))) (= (acomplete a t) (<= (- (h a t) (mh a t)) 1)))))
(declare-fun balance (par (a) (Int (list a)) (pair (tree a) (list a))))
; TODO this cannot be parsed yet
;(assert (par (a) (forall ((n Int) (xs (list a))) (= (balance a n xs) (ite (= n 0) (Pair (tree a) (list a) (Leaf a) xs)
...
(declare-fun bal_list (par (a) (Int (list a)) (tree a)))
(assert (par (a) (forall ((n Int) (xs (list a))) (= (bal_list a n xs) (Pair_0 (tree a) (list a) (balance a n xs))))))
(declare-fun balance_list (par (a) ((list a)) (tree a)))
(assert (par (a) (forall ((xs (list a))) (= (balance_list a xs) (bal_list a (len a xs) xs)))))
(declare-fun bal_tree (par (a) (Int (tree a)) (tree a)))
(assert (par (a) (forall ((n Int) (t (tree a))) (= (bal_tree a n t) (bal_list a n (inorder a t))))))
...
; 2-3 trees
(declare-fun size23 (par (a) ((tree23 a)) Int))
(assert (par (a) (= (size23 a (Leaf23 a)) 0)))
(assert (par (a) (forall ((l (tree23 a)) (x a) (r (tree23 a))) (= (size23 a (Node2 a l x r))
  (+ (size23 a l) (size23 a r) 1)))))
(assert (par (a) (forall ((l (tree23 a)) (x a) (m (tree23 a)) (y a) (r (tree23 a)))
  (= (size23 a (Node3 a l x m y r)) (+ (size23 a l) (size23 a m) (size23 a r) 1)))))
(declare-fun h23 (par (a) ((tree23 a)) Int))
(assert (par (a) (= (h23 a (Leaf23 a)) 0)))
(assert (par (a) (forall ((l (tree23 a)) (x a) (r (tree23 a))) (= (h23 a (Node2 a l x r))
  (+ (max (h23 a l) (h23 a r)) 1)))))
(assert (par (a) (forall ((l (tree23 a)) (x a) (m (tree23 a)) (y a) (r (tree23 a)))
  (= (h23 a (Node3 a l x m y r)) (+ (max (h23 a l) (max (h23 a m) (h23 a r))) 1)))))
...
(declare-fun hI (par (a) ((upI a)) Int))
...
(declare-fun len23s (par (a) ((tree23s a)) Int))
(assert (par (a) (forall ((t (tree23 a))) (= (len23s a (T a t)) 1))))
(assert (par (a) (forall ((t (tree23 a)) (x a) (ts (tree23s a))) (= (len23s a (TTs a t x ts)) (+ (len23s a ts) 1)))))
...
(assert (par (a) (forall ((t1 (tree23 a)) (x a) (t2 (tree23 a)) (y a) (ts (tree23s a))) (= (join_adj a (TTs a t1 x (TTs a t2 y ts)))
  (TTs a (Node2 a t1 x t2) y (join_adj a ts))))))
...
(declare-fun bh (par (a) ((rbt a)) Int))
(assert (par (a) (= (bh a (LeafRB a)) 0)))
(assert (par (a) (forall ((l (rbt a)) (x a) (c color) (r (rbt a))) (= (bh a (NodeRB a l (Pair a color x c) r))
  (ite (= c Black) (+ (bh a l) 1) (bh a l))))))
...
; AVL trees
(declare-fun ht (par (a) ((tree_ht a)) Int))
(assert (par (a) (= (ht a (Leaf (pair a Int))) 0)))
(assert (par (a) (forall ((l (tree_ht a)) (x a) (n Int) (r (tree_ht a))) (= (ht a (Node (pair a Int) l (Pair a Int x n) r)) n))))
(declare-fun node (par (a) ((tree_ht a) a (tree_ht a)) (tree_ht a)))
(assert (par (a) (forall ((l (tree_ht a)) (x a) (r (tree_ht a))) (= (node a l x r) (Node (pair a Int) l (Pair a Int x (+ (max (ht a l) (ht a r)) 1)) r)))))
...
; T_rev(xs) <= (|xs|+1)^2
(assert (par (a) (forall ((xs (list a))) (<= (T_rev a xs) (pow (+ (len a xs) 1) 2)))))
; T_itrev(xs,ys) = |xs|+1
(assert (par (a) (forall ((xs (list a)) (ys (list a))) (= (T_itrev a xs ys) (+ (len a xs) 1)))))
...
; T_isort(xs) <= (|xs|+1)^2
(assert (par (a) (forall ((xs (list a))) (<= (T_isort a xs) (pow (+ (len a xs) 1) 2)))))
; T_insort(x,xs) <= |xs| + 1
(assert (par (a) (forall ((x a) (xs (list a))) (<= (T_insort a x xs) (+ (len a xs) 1)))))
; |insort(x,xs)| = |xs| + 1
(assert (par (a) (forall ((x a) (xs (list a))) (= (len a (insort a x xs)) (+ (len a xs) 1)))))
; |isort(xs)| = |xs|
...
; |merge(xs,ys)| = |xs| + |ys|
(assert (par (a) (forall ((xs (list a)) (ys (list a))) (= (len a (merge a xs ys)) (+ (len a xs) (len a ys))))))
; |msort(xs)| = |xs|
(assert (par (a) (forall ((xs (list a))) (= (len a (msort a xs)) (len a xs)))))
; C_merge(xs,ys) <= |xs| + |ys|
(assert (par (a) (forall ((xs (list a)) (ys (list a))) (<= (C_merge a xs ys) (+ (len a xs) (len a ys))))))
; |xs| = 2^k -> C_msort(xs) <= k * 2^k
(assert (par (a) (forall ((xs (list a)) (k Int)) (=> (= (len a xs) (pow 2 k)) (<= (C_msort a xs) (* k (pow 2 k)))))))
...
(assert (par (a) (forall ((xss (lists a))) (<= (C_merge_adj a xss) (len a (concat a xss))))))
...
(assert (par (a) (forall ((x a) (xs (list a)) (ys (list a))) (= (len a (concat a (desc a x xs ys))) (+ 1 (len a xs) (len a ys))))))
; |concat(runs(xs))| = |xs|
...
; C_asc(a,ys) <= |ys|
(assert (par (a) (forall ((x a) (ys (list a))) (<= (C_asc a x ys) (len a ys)))))
; C_desc(a,ys) <= |ys|
(assert (par (a) (forall ((x a) (ys (list a))) (<= (C_desc a x ys) (len a ys)))))
; C_runs(xs) <= |xs| - 1
(assert (par (a) (forall ((xs (list a))) (<= (C_runs a xs) (- (len a xs) 1)))))
...
; |t|_1 = |t| + 1
(assert (par (a) (forall ((t (tree a))) (= (size1 a t) (+ (size a t) 1)))))
; h(t) <= |t|
(assert (par (a) (forall ((t (tree a))) (<= (h a t) (size a t)))))
; mh(t) <= h(t)
(assert (par (a) (forall ((t (tree a))) (<= (mh a t) (h a t)))))
; 2^mh(t) <= |t|_1
(assert (par (a) (forall ((t (tree a))) (<= (pow 2 (mh a t)) (size1 a t)))))
; |t|_1 <= 2^h(t)
(assert (par (a) (forall ((t (tree a))) (<= (size1 a t) (pow 2 (h a t))))))
...
(assert (par (a) (forall ((t (tree a))) (=> (complete a t) (= (size1 a t) (pow 2 (h a t)))))))
; ~complete(t) -> |t|_1 < 2^h(t)
(assert (par (a) (forall ((t (tree a))) (=> (not (complete a t)) (< (size1 a t) (pow 2 (h a t)))))))
; ~complete(t) -> 2^mh(t) < |t|_1
(assert (par (a) (forall ((t (tree a))) (=> (not (complete a t)) (< (pow 2 (mh a t)) (size1 a t))))))
; complete(t) <-> |t|_1 = 2^h(t)
(assert (par (a) (forall ((t (tree a))) (= (complete a t) (= (size1 a t) (pow 2 (h a t)))))))
; u in subtrees(t) & complete(u) -> h(u) <= h(mcs(t))

; acomplete(s) & |s| <= |t| -> h(s) <= h(t)
(assert (par (a) (forall ((s (tree a)) (t (tree a))) (=> (and (acomplete a s) (<= (size a s) (size a t))) (<= (h a s) (h a t))))))
; acomplete(t) -> h(t) = ceil(lg(|t|_1))

; acomplete(t) -> mh(t) = floor(lg(|t|_1))

; n <= |xs| & bal(n,xs) = (t, zs) -> xs = inorder(t) @ zs & |t| = n
(assert (par (a) (forall ((n Int) (xs (list a)) (t (tree a)) (zs (list a))) (=> (and (<= n (len a xs)) (= (balance a n xs) (Pair (tree a) (list a) t zs)))
  (and (= xs (append a (inorder a t) zs)) (= (size a t) n))))))
; n <= |xs| -> inorder(bal_list(n,xs)) = take(n,xs)
(assert (par (a) (forall ((n Int) (xs (list a))) (=> (<= n (len a xs)) (= (inorder a (bal_list a n xs)) (take a n xs))))))
...
(assert (par (a) (forall ((n Int) (t (tree a))) (=> (<= n (size a t)) (= (inorder a (bal_tree a n t)) (take a n (inorder a t)))))))
...
(assert (par (a) (forall ((n Int) (xs (list a)) (t (tree a)) (ys (list a)))
  (=> (and (<= n (len a xs)) (= (balance a n xs) (Pair (tree a) (list a) t ys))) (acomplete a t)))))
; invar_sz(t) = sz(t) = |t|
...
(assert (par (a) (forall ((l (tree a)) (r (tree a))) (<= (h a (join a l r)) (+ (max (h a l) (h a r)) 1)))))
...
;(assert (forall ((a a) (t (tree a))) (=> (and (inv_max_hi t) (in_set_tree a t)) (<= (high a) (max_hi t)))))
