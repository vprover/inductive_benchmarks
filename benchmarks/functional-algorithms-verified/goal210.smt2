...
(assert-not (par (a b) (forall ((t (ptree a b)) (x a) (y Bool) (l (ptree a b)) (r (ptree a b)))
  (=> (and (= (splitp a b t x) (Triple (ptree a b) Bool (ptree a b) l y r)) (invp a b t)) (and (invp a b l) (invp a b r))))))
