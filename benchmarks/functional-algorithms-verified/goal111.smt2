...
(assert-not (par (a) (forall ((x a) (xs (list a)) (y a) (ys (list a))) (= (sorted_s a (append a (Cons a x xs) (Cons a y ys))) (and (sorted_s a (Cons a x xs)) (less a x y) (sorted_s a (append a xs (Cons a y (Nil a)))) (sorted_s a (Cons a y ys)))))))
