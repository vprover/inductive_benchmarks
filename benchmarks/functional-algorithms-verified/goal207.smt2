...
(assert-not (par (a b) (forall ((l (ptree a b)) (r (ptree a b))) (=> (and (bst (pair a b) l) (bst (pair a b) r) (forall ((x a) (y a)) (=> (and (in_set_ptree a b x l) (in_set_ptree a b y r)) (less a x y)))) (bst (pair a b) (join2 a b l r))))))
