...
(assert-not (par (a b) (forall ((t1 (ptree a b)) (t2 (ptree a b)))
  (=> (bst (pair a b) t2) (forall ((x a)) (= (in_set_ptree a b x (union a b t1 t2)) (or (in_set_ptree a b x t1) (in_set_ptree a b x t2))))))))
