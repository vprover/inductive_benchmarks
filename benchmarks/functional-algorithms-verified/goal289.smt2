...
(assert-not (par (a) (forall ((t (treeh a)) (x a) (y a) (z a) (u a)) (=> (and (consistent a t) (minima a t x y) (in_alphabet a z t) (in_alphabet a u t) (= (depth a t z) (height a t)) (= (depth a t u) (height a t)) (distinct z u)) (leq nat (cost a (swapFourSyms a t x y z u)) (cost a t))))))
