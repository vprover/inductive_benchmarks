...
; invh(t) & invc(t) & t' = del(x,t) -> invh(t') & (color(t) = Red -> bh(t') = bh(t) & invc(t')) & (color(t) = Black -> bh(t') = bh(t) - 1 & invc2(t')) ; deliberate use of s_0 here since t can be a leaf as well
(assert-not (par (a) (forall ((t (rbt a)) (x a) (t' (rbt a))) (=> (and (invh a t) (invc a t) (= (delRB a x t) t')) (and (invh a t') (=> (= (color_of a t) Red) (and (= (bh a t') (bh a t)) (invc a t'))) (=> (= (color_of a t) Black) (and (= (bh a t') (s_0 (bh a t))))))))))
