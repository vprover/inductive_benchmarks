...
(assert-not (par (a) (forall ((t (treeh a)) (x a) (wx nat) (y a) (wy nat)) (=> (and (consistent a t) (in_alphabet a x t) (= (freq a t x) (plus wx wy))) (= (cost a (splitLeaf a t wx x wy y)) (plus (plus (cost a t) wx) wy))))))
