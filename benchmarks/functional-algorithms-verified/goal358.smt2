...
(assert-not (par (a) (forall ((t (tree a)) (x a) (l (tree a)) (y a) (r (tree a))) (=> (and (sorted_s a (inorder a t)) (= (splay a x t) (Node a l y r)))
  (sorted_s a (append a (inorder a l) (Cons a x (inorder a r))))))))
